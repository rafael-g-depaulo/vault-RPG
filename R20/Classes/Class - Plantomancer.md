...
| 1     | Herbomancia: Muda Mágica | Movimento (1PM): Você consegue usar seus sentidos através da **Muda Mágica**, e pode usar magias através dela. (ver: **Herbomancia e Plantas Mágicas**)                                                                                                                                                            |
...
| Polinização Cruzada | Você pode usar habilidades de Plantomancer (incluindo **Herbomancia**) a partir de uma **Muda Mágica**.                                                                                                                                                                                                                                                                       | 4º nível de Plantomancer |
...
| Plantas Conduentes Arcanas               | (ao lançar uma magia) (+**X**PM): Você escolhe **X** **Mudas Mágicas**, e elas lançam a magia ao mesmo tempo em alvos a sua escolha. Uma criatura ou objeto só pode ser afetado por uma instância da magia.                                                                                                                                                                                                                                                                            | 5º nível de Plantomancer |
...
| Pólen de Poder: Corrosão       | Inimigos recebem 2d8 de dano ácido, mas se passar na resistência (CON) tomam metade do dano. Criaturas que falharem por mais que 5 na resistência ficam **Vulneráveis** (-2 defesa). Você pode gastar +1PM para aumentar o dano em 1d8                                         | 4º nível de Plantomancer |
